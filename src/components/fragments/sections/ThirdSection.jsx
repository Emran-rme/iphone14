            ...
            <div className="mx-auto w-[980px] section-content">
                ...
                <div className="flex flex-wrap flex-col-reverse md:flex-row w-full">
                    <div className={styles.large7}>
                        ...
                        >
                            iOS 16 lets you customize your Lock Screen in fun
                            new ways. Layer a photo to make it pop. Track your
                            Activity rings. And see live updates from your
                            favorite&nbsp;apps.
                        </p>
                    </div>
                ...
                <div className="aside-container">
                    <div className="aside-item aside-item-privacy">
                        ...
                        <p className="aside-copy typography-site-callout">
                            App Tracking Transparency lets you decide which apps
                            are allowed to track your activity — it’s just one
                            example of how iPhone is designed to put you in
                            control of what you share and who you share it with
                        </p>
                    </div>
                </div>
            </div>
